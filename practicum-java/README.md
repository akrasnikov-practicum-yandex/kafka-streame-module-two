...
> Подробная пошаговая инструкция с нуля — с ожидаемым выводом каждого шага,
> вариантами команд для PowerShell и разбором типовых ошибок — в
> [QUICKSTART.md](QUICKSTART.md). Ниже — краткая последовательность.
